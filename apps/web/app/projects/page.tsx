...
export const metadata: Metadata = { title: 'Local QR Projects', description: 'Manage QR design projects stored locally in IndexedDB.', alternates: { canonical: '/projects' } };
