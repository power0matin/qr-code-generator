...
export function ProjectsView() {
  ...
  const visible = useMemo(() => {
    ...
    const filtered = projects.filter((project) => {
      ...
      return project.name.toLowerCase().includes(normalizedQuery) || searchablePayload.includes(normalizedQuery);
    });
